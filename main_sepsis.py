...
check_crp_less_10 = ltn.Function(func = lambda x: (x[:, 338:351] < scalers["CRP"].transform([[10]])[0][0]).any(dim=1))
...
check_crp_100 = ltn.Function(func = lambda x: (x[:, 338:351] > scalers["CRP"].transform([[100]])[0][0]).any(dim=1))
check_crp_less_10 = ltn.Function(func = lambda x: (x[:, 338:351] < scalers["CRP"].transform([[10]])[0][0]).any(dim=1))
check_age = ltn.Function(func = lambda x: (x[:, 117:130] > scalers["Age"].transform([[65]])[0][0]).any(dim=1))
has_dysfunc_org = ltn.Function(func = lambda x: (x[:, 26:39].eq(1).any(dim=1)))
has_sirs2ormore = ltn.Function(func = lambda x: (x[:, 182:195].eq(1).any(dim=1)))
